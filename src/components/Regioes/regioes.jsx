...
function Regioes(){
  ...
  >
    ...
    <div class="card_regioes" >
  <img src={leste} class="card-img-top_regioes" alt="..."/>
  <div class="card-body_regioes">
    ...
    <div class="card_regioes" >
  <img src={centro} class="card-img-top_regioes" alt="..."/>
  <div class="card-body_regioes1">
  <a href=''className='regioes'> <h2 className='text2'>Centro</h2></a>
    ...
    <div class="card_regioes" >
  <img src={oeste} class="card-img-top_regioes" alt="..."/>
  <div class="card-body_regioes2">
  <a href=''className='regioes'> <h2 className='text3'>Oeste</h2></a>
  </div>
</div>
    </div>
    <div class="card_regioes" >
  <img src={norte} class="card-img-top_regioes" alt="..."/>
  <div class="card-body_regioes3">
  <a href=''className='regioes'> <h2 className='text4'>Norte</h2></a>
  </div>
</div>
<div class="card_regioes" >
  <img src={sul} class="card-img-top_regioes" alt="..."/>
  <div class="card-body_regioes4">
